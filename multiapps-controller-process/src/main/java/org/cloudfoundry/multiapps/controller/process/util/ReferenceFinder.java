...
public class ReferenceFinder {
    ...
    private boolean hasReferenceInModuleParameters(Module module) {
        ...
        return hasReferenceInHooks(module.getHooks());
    }
    ...
    private boolean hasReferenceInRequiredDependencies(List<? extends RequiredDependency> dependencies) {
        return dependencies.stream()
                           .anyMatch(
                               dependency -> hasReferenceInParametersOrProperties(dependency.getParameters(), dependency.getProperties()));
    }
    ...
    private boolean hasReferenceInResourceParameters(Resource resource) {
        return hasReferenceInParametersOrProperties(resource.getParameters(),
                                                    resource.getProperties()) || hasReferenceInRequiredDependencies(
