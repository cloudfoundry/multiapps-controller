...
public class Messages {
    ...
    public static final String CANT_DETERMINE_CURRENT_USER_GUID = "Cannot determine the current user guid";
    ...
    public static final String HOOK_PHASE_BLUE_GREEN_BEFORE_UNMAP_ROUTES_IDLE_USED = "Hook \"{0}\" uses the deprecated phase \"blue-green.application.before-unmap-routes.idle\". This phase is unreachable and will be removed in a future version.";
    ...
    public static final String ADDING_ROUTE_WITH_HOST_0_DOMAIN_1_AND_PATH_2 = "Adding route with host \"{0}\", domain \"{1}\", path \"{2}\" and options \"{3}\"...";
