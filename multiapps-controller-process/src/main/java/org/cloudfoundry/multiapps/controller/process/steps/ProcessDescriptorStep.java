...
public class ProcessDescriptorStep extends SyncFlowableStep {
    ...
    private MtaDescriptorPropertiesResolverContext buildMtaDescriptorPropertiesResolverContext(ProcessContext context,
        ...
        Boolean applyNamespaceAppNamesOperational = context.getVariable(Variables.APPLY_NAMESPACE_APP_NAMES);
        Boolean applyNamespaceServiceNamesOperational = context.getVariable(Variables.APPLY_NAMESPACE_SERVICE_NAMES);
        Boolean applyNamespaceAppRoutesOperational = context.getVariable(Variables.APPLY_NAMESPACE_APP_ROUTES);
        ...
        return ImmutableMtaDescriptorPropertiesResolverContext.builder()
                                                              ...
                                                              .namespace(namespace)
                                                              .applyNamespaceAppNamesGlobal(namespaceGlobalParameters.getApplyNamespaceAppNamesParameter())
                                                              .applyNamespaceServiceNamesGlobal(namespaceGlobalParameters.getApplyNamespaceServiceNamesParameter())
                                                              .applyNamespaceAppRoutesGlobal(namespaceGlobalParameters.getApplyNamespaceAppRoutesParameter())
                                                              .applyNamespaceAppNamesOperational(applyNamespaceAppNamesOperational)
                                                              .applyNamespaceServiceNamesOperational(applyNamespaceServiceNamesOperational)
                                                              .applyNamespaceAppRoutesOperational(applyNamespaceAppRoutesOperational)
