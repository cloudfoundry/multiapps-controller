    ...
    public static OperationMetadata getMetadata() {
        return ImmutableOperationMetadata.builder()
                                         ...
                                         .addParameter(ImmutableParameterMetadata.builder()
                                                                                 ...
                                                                                 .build())
                                         .addParameter(ImmutableParameterMetadata.builder()
                                                                                 .id(Variables.TASK_EXECUTION_TIMEOUT_COMMAND_LINE_LEVEL.getName())
                                                                                 .type(ParameterType.INTEGER)
                                                                                 .customConverter(new TimeoutParameterConverter(Variables.TASK_EXECUTION_TIMEOUT_COMMAND_LINE_LEVEL))
                                                                                 .build())
                                         .build();
    }
