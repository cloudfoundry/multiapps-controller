    ...
    public static OperationMetadata getMetadata() {
        return ImmutableOperationMetadata.builder()
                                         ...
                                         .addParameter(ImmutableParameterMetadata.builder()
                                                                                 ...
                                                                                 .build())
                                         .addParameter(ImmutableParameterMetadata.builder()
                                                                                 .id(Variables.DELETE_SERVICE_TIMEOUT_PROCESS_VARIABLE.getName())
                                                                                 .type(ParameterType.INTEGER)
                                                                                 .customConverter(new TimeoutParameterConverter(
                                                                                     Variables.DELETE_SERVICE_TIMEOUT_PROCESS_VARIABLE))
                                                                                 .build())
                                         .addParameter(ImmutableParameterMetadata.builder()
                                                                                 .id(Variables.UPDATE_SERVICE_TIMEOUT_PROCESS_VARIABLE.getName())
                                                                                 .type(ParameterType.INTEGER)
                                                                                 .customConverter(new TimeoutParameterConverter(
                                         ...
                                         .addParameter(ImmutableParameterMetadata.builder()
                                                                                 ...
                                                                                 .build())
                                         .addParameter(ImmutableParameterMetadata.builder()
                                                                                 .id(Variables.DELETE_SERVICE_KEY_TIMEOUT_PROCESS_VARIABLE.getName())
                                                                                 .type(ParameterType.INTEGER)
                                                                                 .customConverter(new TimeoutParameterConverter(
