...
public class SupportedParametersCheckerTest {
    ...
    void testCheckSupportedParametersForModule() {
        ...
        List<String> unsupportedParameters = checker.getUnknownParameters(
            createDeploymentDescriptor(moduleList, resourceList, Collections.emptyMap()));
    ...
    void testCheckSupportedGlobalParameters() {
        ...
        List<String> unsupportedParameters = checker.getUnknownParameters(
            createDeploymentDescriptor(moduleList, resourceList, globalParameters));
    ...
    private static List<Module> createModules() {
        ...
        List<ProvidedDependency> providedDependencies = List.of(ProvidedDependency.createV3()
                                                                                  ...
                                                                                  .setParameters(
                                                                                      Map.of(SUPPORTED_DEPENDENCY_PARAMETER, VALUE,
        ...
        return List.of(
            createModule(MODULE_NAME, Map.of(SUPPORTED_MODULE_PARAMETER, VALUE, UNSUPPORTED_MODULE_PARAMETER, VALUE), requiredDependencies,
                         providedDependencies, hooks));
    }
    ...
    private static List<RequiredDependency> createRequiredDependencies() {
        return List.of(RequiredDependency.createV3()
                                         .setName(REQUIRED_DEPENDENCY)
                                         .setParameters(
                                             Map.of(SUPPORTED_DEPENDENCY_PARAMETER, VALUE, UNSUPPORTED_DEPENDENCY_PARAMETER, VALUE)));
    }
