...
class PollServiceBindingOperationExecutionTest extends AsyncStepOperationTest<BindServiceToApplicationStep> {
    ...
    @Test
    void testExecution() {
        context.setVariable(Variables.SERVICE_BINDING_JOB_ID, JOB_ID);
    ...
    protected List<AsyncExecution> getAsyncOperations(ProcessContext wrapper) {
        return List.of(new PollServiceBindingOperationExecution());
    }
