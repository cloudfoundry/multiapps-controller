...
public class MtaArchiveContentResolverTest {
    ...
    public void setUp() throws Exception {
        ...
        resolver = new MtaArchiveContentResolver(helper, processor, sizeTracker);

    }

    public static Stream<Arguments> testResourceResolve() {
        return Stream.of(Arguments.of(List.of(createResource(RESOURCE_NAME)), Map.of(FILENAME, List.of(RESOURCE_NAME)),
                         ...
                         Arguments.of(List.of(createResource(RESOURCE_NAME), createResource(RESOURCE_NAME_2)),
                                      Map.of(FILENAME, List.of(RESOURCE_NAME, RESOURCE_NAME_2)), Map.of(FILENAME, CONTENT_KEY_VALUE_PAIR),
                         ...
                         Arguments.of(List.of(createResource(RESOURCE_NAME), createResource(RESOURCE_NAME_2)),
                                      ...
                                      Map.of(RESOURCE_NAME, Map.of(CONFIG, CONTENT_KEY_VALUE_PAIR), RESOURCE_NAME_2,
                                             Map.of(CONFIG, CONTENT_KEY_VALUE_PAIR_2))),
                         Arguments.of(List.of(createResource(RESOURCE_NAME), createResource(RESOURCE_NAME_2)),
    ...
    @ParameterizedTest
    @MethodSource
    public void testResourceResolve(List<Resource> resourcesList, Map<String, List<String>> archiveEntries,
                                    Map<String, Map<String, Object>> fileContentEntries, Map<String, Object> resolvedResourcesResult) {
        ...
        for (var entry : archiveEntries.entrySet()) {
            Mockito.when(processor.processFileContent(any(), eq(entry)))
                   .thenReturn(fileContentEntries.get(entry.getKey()));
        }
    ...
    public void testWithExistingConfigResourceNoOverwrite() {
        ...
        Mockito.when(processor.processFileContent(any(), eq(entries.entrySet()
                                                                   .iterator()
                                                                   .next())))
        ...
        Map<String, Object> resolvedResourcesResult = Map.of(RESOURCE_NAME,
                                                             Map.of(CONFIG, Map.of(FILE_CONTENT_KEY, "shouldNotOverrideValue")));
    ...
    @ParameterizedTest
    @MethodSource
    public void testModuleResolve(List<Module> moduleList, Map<String, List<String>> archiveEntries,
                                  Map<String, Map<String, Object>> fileContentEntries,
                                  Map<String, Map<String, Object>> resolvedModulesResult) {
    ...
    public void testModuleAndResourceResolve() {
        ...
        Map<String, List<String>> archiveResourceFileAttributes = Map.of(FILENAME, List.of(RESOURCE_NAME, RESOURCE_NAME_2), FILENAME_2,
                                                                         List.of(RESOURCE_NAME_2));

        Mockito.when(helper.getResourceFileAttributes())
               .thenReturn(archiveResourceFileAttributes);
        ...
        for (var entry : archiveResourceFileAttributes.entrySet()) {
            Mockito.when(processor.processFileContent(any(), eq(entry)))
                   .thenReturn(fileContentEntries.get(entry.getKey()));
        }
    ...
    private static void assertResultsMatchActualModule(Map<String, Map<String, Object>> resolvedModulesResult,
