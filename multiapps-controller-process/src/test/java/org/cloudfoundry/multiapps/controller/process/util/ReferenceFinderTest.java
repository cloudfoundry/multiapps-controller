...
public class ReferenceFinderTest {
    ...
    void testReferenceFinderNotReferenced() {
        ...
        Assertions.assertFalse(finder.isParameterReferenced(createDeploymentDescriptor(createModules(), createResources(),
                                                                                       globalParameters),
    ...
    void testReferenceFinderReferencedInParameters() {
        ...
        Assertions.assertTrue(finder.isParameterReferenced(createDeploymentDescriptor(moduleList, Collections.emptyList(),
