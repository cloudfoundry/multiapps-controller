...
class AwsS3ObjectStoreFileStorageTest {
    ...
    void testDeleteFilesBySpaceIdsWithAllMatchingItems() {
        ...
        setupHeadObjectWithMetadata(TEST_ID, TEST_SPACE_ID, NAMESPACE, LocalDateTime.now());
        setupHeadObjectWithMetadata(TEST_ID_2, TEST_SPACE_ID_2, NAMESPACE_2, LocalDateTime.now());
    ...
    void testDeleteFilesModifiedBefore() {
        LocalDateTime oldModified = LocalDateTime.now()
                                                 .minusMinutes(15);
        ...
        int deletedCount = fileStorage.deleteFilesModifiedBefore(LocalDateTime.now());
    ...
    void testDeleteFilesBySpaceIdsWithPagination() {
        ...
        when(s3Client.deleteObjects(any(DeleteObjectsRequest.class))).thenReturn(DeleteObjectsResponse.builder()
                                                                                                      .build());
        setupHeadObjectWithMetadata(TEST_ID, TEST_SPACE_ID, NAMESPACE, LocalDateTime.now());
        setupHeadObjectWithMetadata(TEST_ID_2, TEST_SPACE_ID, NAMESPACE, LocalDateTime.now());
        setupHeadObjectWithMetadata(thirdId, TEST_SPACE_ID_2, NAMESPACE_2, LocalDateTime.now());
