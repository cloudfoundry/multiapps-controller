...
public class CreateServicesStepTest extends AbstractStepTest<CreateServicesStep> {
...
// @formatter:off
            ...
            {
                "create-services-step-input-1.json", null,
            },
            ...
            {
                "create-services-step-input-12.json", null,
            },
            // (12) Test update of service keys:
            {
                "create-services-step-input-13.json", null,
            },
            // (13) Test delete of service keys:
            {
                "create-services-step-input-14.json", null,
            },
// @formatter:on
        });
    }

    public CreateServicesStepTest(String stepInput, String expectedExceptionMessage) throws Exception {
        this.stepInput = JsonUtil.fromJson(TestUtil.getResourceAsString(stepInput, CreateServicesStepTest.class), StepInput.class);
    ...
    private void prepareClient() throws Exception {
        ...
        step.clientExtensionsSupplier = (context) -> clientExtensions;
    ...
    @Override
    protected CreateServicesStep createStep() {
        return new CreateServicesStep();
    }
