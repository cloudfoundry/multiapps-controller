...
public class AbstractXS2ProcessStepTest extends AbstractStepTest<AbstractXS2ProcessStepTest.MockStep> {
...
// @formatter:on
    ...
    public AbstractXS2ProcessStepTest(Exception exceptionToSimulate, ErrorType expectedErrorType) {
    ...
    public static class MockStep extends AbstractXS2ProcessStep {
