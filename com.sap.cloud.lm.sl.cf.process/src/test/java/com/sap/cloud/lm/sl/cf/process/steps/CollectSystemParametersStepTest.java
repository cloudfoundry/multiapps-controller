...
// @formatter:off
            ...
            {
                new StepInput("mtad-tcp-tcps.yaml", "https://localhost:30032/uaa-security", "https://deploy-service-url:51002", "localhost", false, true , true , "XSMASTER", "initial initial", "initial", "initial", 3, 0, null, PlatformType.XS2, false), 
            ...
            {
                new StepInput("mtad-tcp-tcps.yaml", "https://localhost:30032/uaa-security", "https://deploy-service-url:51002", "localhost", false, true , true , "XSMASTER", "initial initial", "initial", "initial", 3, 0, "deployed-mta-13.json", PlatformType.XS2, false), 
                new StepOutput(new TreeSet<>(Arrays.asList(1, 2)), "R:system-parameters-12.json", null),
            },
            // (9) Host based routing with TCP/TCPS with existing apps with TCP uris
            {
                new StepInput("mtad-tcp-tcps.yaml", "https://localhost:30032/uaa-security", "https://deploy-service-url:51002", "localhost", false, true , true , "XSMASTER", "initial initial", "initial", "initial", 3, 0, "deployed-mta-14.json", PlatformType.XS2, false), 
