...
public class ValidateDeployParametersStepTest extends AbstractStepTest<ValidateDeployParametersStep> {
    ...
    private void prepareContext() {
        ...
        context.setVariable(com.sap.cloud.lm.sl.slp.Constants.VARIABLE_NAME_SPACE_ID, "space-id");
        context.setVariable(com.sap.cloud.lm.sl.slp.Constants.VARIABLE_NAME_SERVICE_ID, "service-id");
    }
