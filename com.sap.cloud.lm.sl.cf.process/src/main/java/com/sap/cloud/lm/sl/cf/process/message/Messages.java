...
public class Messages {
    ...
    public static final String NO_DEPLOYED_MTA_DETECTED = "No deployed MTA detected";
    public static final String DEPLOYED_MTA_DETECTED = "Deployed MTA detected";
    ...
    public static final String NEW_MTA_VERSION = "New MTA version: {0}";
    ...
    public static final String CREATING_APP = "Creating application \"{0}\"...";
