...
public class XS2DeployServiceMetadata extends ServiceMetadata {
    ...
    private static final RoadmapStepMetadata ROADMAP_PREPARE = new RoadmapStepMetadata("roadmap_prepare", "Prepare", "Prepare",
        new StepMetadata[] { STEP_START, ProcessGitSourceStep.getMetadata(), ValidateDeployParametersStep.getMetadata(),
            ...
            CollectSystemParametersStep.getMetadata(), ProcessDescriptorStep.getMetadata(), BuildCloudDeployModelStep.getMetadata(),
            BuildCloudUndeployModelStep.getMetadata(), CheckForCreationConflictsStep.getMetadata(), });
    ...
    public XS2DeployServiceMetadata() {
        super(Constants.DEPLOY_SERVICE_ID, "Deploy", "Deploy", new RoadmapStepMetadata[] { ROADMAP_PREPARE, ROADMAP_EXECUTE },
            Constants.SERVICE_VERSION_1_1, PARAMS, null);
    }
