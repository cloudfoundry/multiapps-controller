...
// @formatter:off
            ...
            {
                "targets-1.json", new GetRequestInput(42), new RestResponse("E:Deploy target with id \"42\" does not exist"),
            },
            ...
            {
                "targets-1.json", new PostRequestInput("", "target-4.xml", ""), new RestResponse("E:cvc-complex-type.2.4.a: Invalid content was found starting with element properties."),
            },
            // (07) Create platform with missing organization and space:
            {
                "targets-1.json", new PostRequestInput("", "target-5.xml", ""), new RestResponse("E:Target does not contain 'org' and 'space' parameters"),
            },
            ...
            {
                "targets-1.json", new PutRequestInput(1, "target-7.xml", ""), new RestResponse("E:cvc-complex-type.2.4.a: Invalid content was found starting with element properties."),
            },
            // (11) Update platform with missing organization and space:
            {
                "targets-1.json", new PutRequestInput(1, "target-8.xml", ""), new RestResponse("E:Target does not contain 'org' and 'space' parameters"),
            },
            ...
            {
                "targets-1.json", new PutRequestInput(1, "target-10.xml", ""), new RestResponse("E:Invalid value for key \"name\", maximum length is 128"),
            },
            // (16) Create platform with invalid name:
            {
                "targets-1.json", new PostRequestInput("XS@-INITI@L", "target-11.xml", ""), new RestResponse("E:Invalid value for key \"name\", matching failed at \"XS[@]-INITI@L\""),
            },
            // (17) Create platform with invalid name for module type:
            {
                "targets-1.json", new PostRequestInput("XSA", "target-12.xml", ""), new RestResponse("E:Invalid value for key \"module-types#0#name\", matching failed at \"com[/]sap/static-content\""),
            },
// @formatter:on
        });
    }
    ...
    public void setUp() throws Throwable {
        ...
        List<com.sap.cloud.lm.sl.mta.model.v1_0.Target> rawTargets = new ConfigurationParser().parseTargetsJson(
            getClass().getResourceAsStream(targetsJson));
        targets = new ArrayList<>();
        int id = 1;
        for (com.sap.cloud.lm.sl.mta.model.v1_0.Target rawTarget : rawTargets) {
            targets.add(new PersistentObject<Target>(id, (Target) rawTarget));
            id++;
        }
    }
