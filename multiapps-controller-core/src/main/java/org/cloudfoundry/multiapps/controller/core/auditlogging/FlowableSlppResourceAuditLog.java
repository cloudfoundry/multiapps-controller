...
public class FlowableSlppResourceAuditLog {
    ...
    public void auditLogConfigurationChange(String username, String spaceId, String action, String configuration,
                                            Map<String, String> parameters, ConfigurationChangeActions configurationAction) {
        auditLoggingFacade.logConfigurationChangeAuditLog(new AuditLogConfiguration(username, spaceId, action, configuration, parameters),
                                                          configurationAction);
    }
