...
public class ServiceNameValidator implements ParameterValidator {
    ...
    public ServiceNameValidator(String namespace, boolean applyNamespaceGlobal, Boolean applyNamespaceOperational) {
    ...
    public Object attemptToCorrect(Object serviceName, final Map<String, Object> relatedParameters) {
        ...
        return NameUtil.computeValidServiceName((String) serviceName, namespace, applyNamespaceResult);
    }
