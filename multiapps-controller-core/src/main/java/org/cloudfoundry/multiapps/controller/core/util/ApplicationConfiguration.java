...
public class ApplicationConfiguration {
    ...
    private Set<String> getNotSensitiveConfigVariables() {
        return Set.of(CFG_TYPE, CFG_DB_TYPE, CFG_PLATFORM, CFG_MAX_UPLOAD_SIZE, CFG_MAX_MTA_DESCRIPTOR_SIZE, CFG_MAX_MANIFEST_SIZE,
                      CFG_MAX_RESOURCE_FILE_SIZE, CFG_USE_XS_AUDIT_LOGGING, CFG_BASIC_AUTH_ENABLED, CFG_GLOBAL_AUDITOR_USER,
