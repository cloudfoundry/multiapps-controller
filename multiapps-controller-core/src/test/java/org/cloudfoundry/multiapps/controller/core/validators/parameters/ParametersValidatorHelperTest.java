...
class ParametersValidatorHelperTest {
    ...
    private final List<ParameterValidator> validators = List.of(new HostValidator(null, false, null, false, null), new DomainValidator(),
                                                                new RoutesValidator(null, false, null, false, null),
                                                                new ApplicationNameValidator("namespace", true, null, false, null));
