...
// @formatter:on
    ...
    @ParameterizedTest
    @MethodSource
    void testValidateHostWithNamespace(Object host, Map<String, Object> context, Boolean applyNamespaceOperational,
                                       boolean applyNamespaceGlobal, String namespace, boolean expectedValidHost) {
        HostValidator hostValidator = new HostValidator(namespace, applyNamespaceGlobal, applyNamespaceOperational);
    ...
    @ParameterizedTest
    @MethodSource
    void testAttemptToCorrectHostWithNamespace(Object host, Map<String, Object> context, Boolean applyNamespaceOperational,
                                               boolean applyNamespaceGlobal, String namespace, Expectation expectation) {
        HostValidator hostValidator = new HostValidator(namespace, applyNamespaceGlobal, applyNamespaceOperational);
