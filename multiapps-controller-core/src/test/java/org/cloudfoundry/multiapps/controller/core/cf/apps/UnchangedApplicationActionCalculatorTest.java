...
class UnchangedApplicationActionCalculatorTest {
    ...
    @ParameterizedTest
    @MethodSource
    void testUnchangedApplicationCalculator(ApplicationStartupState currentState, ApplicationStartupState desiredState,
                                            boolean isApplicationStagedCorrectly, List<ApplicationStateAction> expectedApplicationActions) {
