    ...
    public static Stream<Arguments> testUriParameterParsing() {
        ...
        return Stream.of(
            ...
            Arguments.of("some-host", null, null, null, null,
                new Expectation(Expectation.Type.STRING, Collections.singletonList("some-host." + DEFAULT_DOMAIN).toString())),
            // with host and domain parameters
            Arguments.of("some-host", "some-domain.com", null, null, null,
                new Expectation(Expectation.Type.STRING, Collections.singletonList("some-host.some-domain.com").toString())),
            ...
            Arguments.of("host1", "domain1.com", Collections.singletonList("host2"), Arrays.asList("domain2.com", "domain3.com"), null,
            ...
            Arguments.of(null, null, null, null, Collections.singletonList("my.custom.route"),
                new Expectation(Expectation.Type.STRING, Collections.singletonList("my.custom.route").toString())),
