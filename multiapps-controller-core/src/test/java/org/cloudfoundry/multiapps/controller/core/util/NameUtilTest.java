...
class NameUtilTest {
    ...
    static Stream<Arguments> testComputeNamespacedNameWithLength() {
        return Stream.of(Arguments.of("name", "namespace", true, 100, "namespace-name"),
                         ...
                         Arguments.of("this-name-is-exactly-34-chars-long", "at-this-point-only-namespace-present", true, 40,
                                      "at-this-point-only-namespace-pre7548697a"),
                         Arguments.of("this-name-is-exactly-34-chars-long", "same-length-namespace-but-less-limit", true, 30,
                                      "same-length-namespace-774ffaef"));
    }

    @ParameterizedTest
    @MethodSource
    void testComputeNamespacedNameWithLength(String name, String namespace, boolean applyNamespace, int maxLength, String expectedName) {
