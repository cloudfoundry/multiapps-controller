...
class ActiveOperationsJmxReporterTest {
    ...
    void setUp() {
        ...
        reporter = new ActiveOperationsJmxReporter(operationService, mBeanServer, applicationConfiguration);
        enableReporting();
    }
    ...
    @Test
    void testSkipsRefreshWhenRateLimitingDisabled() {
    ...
    @Test
    void testSkipsRefreshWhenNotSelectedInstance() {
