...
class CFExceptionMapperTest {
    ...
    @ParameterizedTest
    @MethodSource
    void testHandleException(Exception exception, RestResponse expectedResponse) {
    ...
    static Stream<Arguments> testHandleException() {
        return Stream.of(Arguments.of(new NotFoundException("Not found"), new RestResponse(404, "Not found")),
                         ...
                         Arguments.of(new IllegalArgumentException("Illegal argument exception"),
                                      new RestResponse(400, "Illegal argument exception")),
                         Arguments.of(new HttpMessageNotReadableException("Bad request body", null, null),
                                      new RestResponse(400, "Bad request body")),
    ...
    static Stream<HttpStatus> testHandleExceptionForCloudOperationExceptionWithAllHttpStatuses() {
