...
public class SqlFileQueryProvider {
    ...
    private static final String INSERT_FILE = "INSERT INTO %s (FILE_ID, SPACE, FILE_NAME, NAMESPACE, FILE_SIZE, DIGEST, DIGEST_ALGORITHM, MODIFIED, CONTENT) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public SqlQuery<Boolean> getStoreFileQuery(FileEntry fileEntry, InputStream content) {
        return (Connection connection) -> {
            ...
            try {
                statement = connection.prepareStatement(getQuery(INSERT_FILE));
    ...
    public SqlQuery<Integer> getDeleteAllQuery(final String space, final String namespace) {
        return (Connection connection) -> {
            PreparedStatement statement = null;
            try {
    ...
    public SqlQuery<Boolean> getDeleteFileAttributesQuery(final String space, final String id) {
        return (Connection connection) -> {
            PreparedStatement statement = null;
            try {
    ...
    public SqlQuery<Boolean> getStoreFileContentQuery(FileEntry fileEntry, InputStream inputStream) {
        return (Connection connection) -> {
            PreparedStatement statement = null;
            try {
    ...
    public SqlQuery<Void> getProcessFileContentQuery(final FileDownloadProcessor fileDownloadProcessor) {
        return (Connection connection) -> {
            PreparedStatement statement = null;
            ResultSet resultSet = null;
            try {
