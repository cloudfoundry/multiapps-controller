...
public final class Messages {
    ...
    public static final String ERROR_DELETING_MESSAGES_WITH_PROCESS_ID_TASK_ID = "Error deleting messages with process ID \"{0}\" and task ID \"{1}\"";
    ...
    public static final String ERROR_GETTING_MESSAGES_WITH_PROCESS_ID_TASK_ID = "Error getting messages with process ID \"{0}\", task ID \"{1}\"";
    ...
    public static final String ERROR_GETTING_MESSAGES_WITH_PROCESS_ID_TASK_ID_AND_TYPE = "Error getting messages with process ID \"{0}\", task ID \"{1}\" and type \"{2}\"";
