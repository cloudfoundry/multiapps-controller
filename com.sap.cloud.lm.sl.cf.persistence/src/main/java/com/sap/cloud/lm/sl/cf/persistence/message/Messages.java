...
public final class Messages {
    ...
    public static final String COULD_NOT_COMPUTE_DIGEST_OF_STREAM = "Could not compute digest of stream: {0}";
    ...
    public static final String STORED_FILE_0_SUCCESSFULLY = "Stored file \"{0}\" successfully.";
