...
// @formatter:off
            ...
            {
                "unsecured-object-00.json", Object.class, Arrays.asList("pwd", "pass"), new Expectation(Expectation.Type.RESOURCE, "secured-object-00.json"),
            },
            // (1) Sensitive information should be detected in element keys, but there's a typo in one of the keys:
            {
                "unsecured-object-01.json", Object.class, Arrays.asList("pwd", "pass"), new Expectation(Expectation.Type.RESOURCE, "secured-object-01.json"),
            },
            // (2) Sensitive information should be detected in element values:
            {
                "unsecured-object-02.json", Object.class, Arrays.asList("pwd", "pass"), new Expectation(Expectation.Type.RESOURCE, "secured-object-02.json"),
            },
            // (3) Sensitive information should be detected in element values:
            {
                "unsecured-object-03.json", DeploymentDescriptor.class, Arrays.asList(), new Expectation(Expectation.Type.RESOURCE, "secured-object-03.json"),
            },
            // (4) Sensitive information should be detected in element values:
            {
                "unsecured-object-04.json", DeploymentDescriptor.class, Arrays.asList(), new Expectation(Expectation.Type.RESOURCE, "secured-object-04.json"),
            },
// @formatter:on
        });
    }
    ...
    public void testToJson() throws Exception {
        Object object = JsonUtil.fromJson(TestUtil.getResourceAsString(objectLocation, getClass()), classOfObject);
        test(() -> {
