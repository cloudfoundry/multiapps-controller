...
// @formatter:off
            ...
            // (33) With 'keep-existing-routes' set to true and no deployed MTA:
            {
                ...
                new String[] { "foo" }, // mtaModules
                new String[] {}, // deployedApps
                new String[] { "[]", "[]", "R:keep-existing-routes/apps.json", }
            },
            ...
            // (36) With 'keep-existing-routes' set to true and an already deployed module:
            {
                ...
                new String[] { "foo" }, // mtaModules
                new String[] {}, // deployedApps
                new String[] { "[]", "[]", "R:keep-existing-routes/apps-with-existing-routes.json", }
            },
...
// @formatter:on
    ...
    protected ApplicationsCloudModelBuilder getApplicationsCloudModelBuilder(DeploymentDescriptor deploymentDescriptor,
        ...
        return new com.sap.cloud.lm.sl.cf.core.cf.v2_0.ApplicationsCloudModelBuilder(
            (com.sap.cloud.lm.sl.mta.model.v2_0.DeploymentDescriptor) deploymentDescriptor, configuration, deployedMta, systemParameters,
