...
public class ApplicationEntityUpdaterTest {
...
// @formatter:on
    ...
    @InjectMocks
    private ApplicationEntityUpdater applicationUpdater = new ApplicationEntityUpdater();

    private StepInput input;
    private StagingExtended updateStaging;

    public ApplicationEntityUpdaterTest(String inputLocation) throws Exception {
    ...
    public void testUpdate() {
        applicationUpdater.updateApplicationStaging(client, input.application.appName, updateStaging);
