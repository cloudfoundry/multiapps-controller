...
public class ResourceTypeFinder extends com.sap.cloud.lm.sl.cf.core.helpers.v1_0.ResourceTypeFinder {
    ...
    @Override
    public void visit(ElementContext context, com.sap.cloud.lm.sl.mta.model.v1_0.ResourceType resourceType) {
        visit(context, (com.sap.cloud.lm.sl.mta.model.v2_0.ResourceType) resourceType);
    }
