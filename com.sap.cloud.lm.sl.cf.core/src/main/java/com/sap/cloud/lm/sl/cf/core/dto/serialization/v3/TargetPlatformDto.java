...
public class TargetPlatformDto extends com.sap.cloud.lm.sl.cf.core.dto.serialization.TargetPlatformDto {
    ...
    public TargetPlatformDto(TargetPlatform platform) {
        ...
        this.platformModuleTypes = MT_ADAPTER.marshal(platform.getModuleTypes3_1());
        this.platformResourceTypes = RT_ADAPTER.marshal(platform.getResourceTypes3_1());
    }
    ...
    public TargetPlatform toTargetPlatform() {
        ...
        result.setModuleTypes3_1(MT_ADAPTER.unmarshal(platformModuleTypes));
        result.setResourceTypes3_1(RT_ADAPTER.unmarshal(platformResourceTypes));
        return result.build();
    }
