...
import com.sap.cloud.lm.sl.cf.core.cf.v3_1.ApplicationsCloudModelBuilder;
...
public class HelperFactory extends com.sap.cloud.lm.sl.cf.core.cf.factory.v3_0.HelperFactory {
    ...
    public ApplicationsCloudModelBuilder getApplicationsCloudModelBuilder(DeploymentDescriptor deploymentDescriptor,
        ...
        return new ApplicationsCloudModelBuilder((com.sap.cloud.lm.sl.mta.model.v3_1.DeploymentDescriptor) deploymentDescriptor,
    ...
    public ServiceKeysCloudModelBuilder getServiceKeysCloudModelBuilder(DeploymentDescriptor deploymentDescriptor, PropertiesAccessor propertiesAccessor) {
        return new com.sap.cloud.lm.sl.cf.core.cf.v3_1.ServiceKeysCloudModelBuilder(deploymentDescriptor, propertiesAccessor);
    }
}
