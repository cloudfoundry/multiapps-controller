...
public class DescriptorParametersValidator extends ParametersValidator<DeploymentDescriptor> {
    ...
    protected List<Resource> validateResources(List<Resource> resources) throws SLException {
    ...
    protected Resource validate(Resource resource) throws SLException {
    ...
    protected List<Module> validateModules(List<Module> modules) throws SLException {
    ...
    protected Module validate(Module module) throws SLException {
