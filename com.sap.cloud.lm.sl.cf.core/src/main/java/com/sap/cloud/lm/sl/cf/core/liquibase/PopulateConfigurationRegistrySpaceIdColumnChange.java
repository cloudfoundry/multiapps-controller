...
public class PopulateConfigurationRegistrySpaceIdColumnChange
    ...
    protected CloudFoundryClient getCFClient() {
        ...
        CloudCredentials cloudCredentials = new CloudCredentials(Configuration.getInstance().getAdminUsername(),
            Configuration.getInstance().getAdminPassword(), SecurityUtil.CLIENT_ID, SecurityUtil.CLIENT_SECRET);
