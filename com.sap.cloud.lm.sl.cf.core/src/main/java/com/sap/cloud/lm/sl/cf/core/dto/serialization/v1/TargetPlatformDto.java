...
public class TargetPlatformDto extends com.sap.cloud.lm.sl.cf.core.dto.serialization.TargetPlatformDto {
    ...
    public TargetPlatformDto(TargetPlatform platform) {
        ...
        this.properties = platform.getProperties();
        this.platformModuleTypes = MT_ADAPTER.marshal(platform.getModuleTypes1_0());
        this.platformResourceTypes = RT_ADAPTER.marshal(platform.getResourceTypes1_0());
    }
    ...
    public TargetPlatform toTargetPlatform() {
        ...
        result.setModuleTypes1_0(MT_ADAPTER.unmarshal(platformModuleTypes));
        result.setResourceTypes1_0(RT_ADAPTER.unmarshal(platformResourceTypes));
        return result.build();
    }
