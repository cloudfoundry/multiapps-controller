...
@Entity(name = "TargetPlatform1")
@Access(AccessType.FIELD)
@NamedQuery(name = "find_all_v1", query = "SELECT tp FROM TargetPlatform1 tp")
@Table(name = "target_platform_v1")
public class TargetPlatformDto extends com.sap.cloud.lm.sl.cf.core.dto.serialization.TargetPlatformDto {
    ...
    public TargetPlatformDto(TargetPlatform platform) {
        ...
        this.xmlContent = XmlUtil.toXml(new com.sap.cloud.lm.sl.cf.core.dto.serialization.v1.TargetPlatformDto(platform));
    }

    @Override
    public TargetPlatform toTargetPlatform() {
        return XmlUtil.fromXml(xmlContent, com.sap.cloud.lm.sl.cf.core.dto.serialization.v1.TargetPlatformDto.class).toTargetPlatform();
    }
