...
public class OperationMetadata {
    ...
    public static class OperationMetadataBuilder {
        ...
        public OperationMetadata build() {
            ...
            metadata.previousActivitiDiagramIds = CommonUtil.getOrDefault(previousActivitiDiagramIds, Collections.emptyList());
            metadata.versions = CommonUtil.getOrDefault(versions, Collections.emptyList());
            return metadata;
        }
